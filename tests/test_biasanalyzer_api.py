...
def test_set_config(caplog, fresh_bias_obj):
    ...
    caplog.clear()
    with caplog.at_level(logging.ERROR):
        invalid_config_file = os.path.join(os.path.dirname(__file__), "assets", "config", "test_invalid_config.yaml")
...
def test_set_root_omop(monkeypatch, caplog, fresh_bias_obj):
    ...
    caplog.clear()
    with caplog.at_level(logging.INFO):
        config_file_with_unsupported_db_type = os.path.join(
            os.path.dirname(__file__), "assets", "config", "test_config_unsupported_db_type.yaml"
        )
        ...
        "hierarchy": [
            {
                ...
                "metrics": {"1": {"count": 2, "prevalence": 0.4}, "2": {"count": 2, "prevalence": 0.5}},
                "source_cohorts": [1, 2],
                "parent_ids": [],
                "children": [],
            },
            {
                ...
                "metrics": {"1": {"count": 4, "prevalence": 0.8}, "2": {"count": 1, "prevalence": 0.25}},
                "source_cohorts": [1, 2],
                "parent_ids": [],
                "children": [],
            },
            {
                ...
                "metrics": {"1": {"count": 4, "prevalence": 0.8}, "2": {"count": 4, "prevalence": 1.0}},
                "source_cohorts": [1, 2],
                "parent_ids": [],
                "children": [],
            },
...
def test_get_domains_and_vocabularies(test_db):
    ...
    expected = [
        {"domain_id": "Condition", "vocabulary_id": "ICD10CM"},
...
def test_display_concept_tree_text_format(capsys, test_db):
    sample_tree = {"details": {"concept_id": 123, "concept_name": "Hypertension", "concept_code": "I10"}}
    ...
    sample_tree["children"] = [
        {
            "details": {"concept_id": 456, "concept_name": "Essential Hypertension", "concept_code": "I10.0"},
            "children": [],
        }
    ]
...
def test_display_concept_tree_widget(test_db):
    sample_tree = {
        "details": {"concept_id": 456, "concept_name": "Essential Hypertension", "concept_code": "I10.0"},
        "parents": [
            {"details": {"concept_id": 123, "concept_name": "Hypertension", "concept_code": "I10"}, "parents": []}
        ],
    }
